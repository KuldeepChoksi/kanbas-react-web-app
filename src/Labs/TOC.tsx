...
export default function TOC(){
  const { pathname } = useLocation();
    return(
      ...
      <li className = "nav-item"><a id="wd-a3" href="#/Kanbas" className="nav-link">Kanbas</a></li>
      <li className = "nav-item"><a id="wd-k" href="https://github.com/KuldeepChoksi" className="nav-link">My GitHub</a></li>
    </ul>
    )
}